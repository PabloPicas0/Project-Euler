...
//  .
// If  S(A)
//   is minimised for a given n, we shall call it an optimum special sum set. The first five optimum special sum sets are given below.
...
//   to be  A={11,17,20,22,23,24}
//  , with  S(A)=117
//  . However, this is not the optimum set, as we have merely applied an algorithm to provide a near optimum set. The optimum set for  n=6
//   is  A={11,18,19,20,22,25}
//  , with  S(A)=115
